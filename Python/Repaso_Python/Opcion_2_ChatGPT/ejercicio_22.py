"""PARTE 7 — Validaciones
Añadir validaciones:
Ejercicio 21
No permitir año negativo."""
import sqlite3
class Libro:
...
def menuInsertar(mi_biblioteca):
    ...
    if titulo == "":
        print("El titulo no puede estar vacio. Vuelve a introducir los datos")
    ...
    if anio < 0 | paginas <0:
        print("El año o las páginas no puede ser negativs. Vuelve a introducir los datos")
        menuInsertar(mi_biblioteca)
